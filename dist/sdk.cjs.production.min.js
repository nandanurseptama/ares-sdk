...
var e = t(require('jsbi')),
  ...
  i = '0x691162f961b783c19d9d12deaad72e9dcdd2f5734789d755a2666ac209b1a4a1',
  s = e.BigInt(1e3),
  a = e.BigInt(0),
  c = e.BigInt(1),
  p = e.BigInt(5),
...
var I = 'setPrototypeOf' in Object,
  x = (function(t) {
    function e() {
      ...
      return (
        ...
        I && Object.setPrototypeOf(k(n), (this instanceof e ? this.constructor : void 0).prototype),
        n
      )
    }
    return f(e, t), e
  ...
  E = (function() {
    ...
    t.getAddress = function(t, e) {
      return b({ factoryAddress: '0xccB9014374CFC7dFaB64d21D608e4b25719d3B87', tokenA: t, tokenB: e })
    }
    var o = t.prototype
    return (
      ...
      (o.getOutputAmount = function(o) {
        ...
        if (e.equal(h.quotient, a)) throw new O()
      ...
      (o.getLiquidityMinted = function(t, o, u) {
        ...
        if (!e.greaterThan(i, a)) throw new O()
        ...
        if (
          ...
          if (e.equal(l, a)) c = o
            ...
            if (e.greaterThan(m, h)) {
              var d = e.multiply(o.quotient, e.subtract(m, h)),
                f = e.add(e.multiply(m, p), h),
                y = e.divide(d, f)
    ...
    (t.bestTradeExactIn = function(e, o, u, i, s, c, p) {
      ...
      for (var y = c.wrapped, v = u.wrapped, T = 0; T < e.length; T++) {
        ...
        if (
          ...
          else if (f > 1 && e.length > 1) {
            var k = e.slice(0, T).concat(e.slice(T + 1, e.length))
            t.bestTradeExactIn(k, o, u, { maxNumResults: h, maxHops: f - 1 }, [].concat(s, [A]), q, p)
          }
        }
      }
      return p
      ...
      for (var y = c.wrapped, v = o.wrapped, T = 0; T < e.length; T++) {
        ...
        if (
          ...
          if (q.currency.equals(v))
            ...
            var k = e.slice(0, T).concat(e.slice(T + 1, e.length))
            t.bestTradeExactOut(k, o, u, { maxNumResults: h, maxHops: f - 1 }, [A].concat(s), q, p)
          }
        }
      }
      return p
  ...
  return (
    (t.swapCallParameters = function(t, e) {
      ...
      var i,
        ...
        d = Boolean(e.feeOnTransfer)
      switch (t.tradeType) {
        case n.TradeType.EXACT_INPUT:
          o
            ? ((i = d ? 'swapExactETHForTokensSupportingFeeOnTransferTokens' : 'swapExactETHForTokens'),
              (s = [l, m, c, h]),
              (a = p))
            : u
            ? ((i = d ? 'swapExactTokensForETHSupportingFeeOnTransferTokens' : 'swapExactTokensForETH'),
              (s = [p, l, m, c, h]),
              (a = '0x0'))
            : ((i = d ? 'swapExactTokensForTokensSupportingFeeOnTransferTokens' : 'swapExactTokensForTokens'),
              (s = [p, l, m, c, h]),
              (a = '0x0'))
          break
...
;(exports.FACTORY_ADDRESS = '0xccB9014374CFC7dFaB64d21D608e4b25719d3B87'),
